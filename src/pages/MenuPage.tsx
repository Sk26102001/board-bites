...
//           >
//             Our Premium <span className="italic text-primary">Event Carts</span>
//           </motion.h1>
...
//                     <a
//                       href="/booking"
//                       className="inline-flex items-center justify-center px-12 py-5 bg-primary text-white font-semibold text-xl rounded-full shadow-xl hover:brightness-110 transition-all duration-300 hover:shadow-2xl hover:scale-[1.03]"
//                     >
//                       Book Now
//                     </a>
        ...
        <div className="container mx-auto px-5 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <AnimatePresence mode="wait">
            ...
            >
                    ...
                    >
                      <div className="bg-white rounded-2xl overflow-hidden shadow-2xl border border-[#d4e0d4]">
                        ...
                        <div className="p-7 md:p-9 text-center bg-gradient-to-b from-[#fafcf9] to-[#f4f7f4]">
                          ...
                          <p className="text-[#5f7a47] text-base italic mb-8 max-w-prose mx-auto leading-relaxed">
                            {cart.description}
                          </p>

                          {/* Per-Cart Pricing */}
                          <div className="mb-8">
                            <p className="text-sm uppercase tracking-wide text-[#71797e] font-medium mb-4">
                              ...
                              {Object.entries(cart.prices).map(([range, price]) => (
                                <div
                                  ...
                                  className={`p-4 rounded-xl border ${
                                    price && price !== "–"
                                      ? "border-[#6b8e23] bg-[#e8efe8]/40"
                                      : "border-gray-200 bg-gray-50 opacity-60"
                                  }`}
                                >
                                  <div className="text-sm font-medium text-[#71797e] mb-1">
                                    {range} Guests
                                  </div>
                                  <div
                                    className={`text-xl md:text-2xl font-bold ${
                                      price && price !== "–" ? "text-[#5f7a47]" : "text-gray-400"
                                    }`}
                                  >
                          ...
                          {cart.note && (
                            <p className="text-sm text-[#6b8e23] italic font-medium mt-6">
                              {cart.note}
                            </p>
                          )}
                        </div>
              ...
              {/* Consolidated Pricing Overview - only shown in "All" view */}
              {active === "All" && (
                <motion.div
                  initial={{ opacity: 0, y: 40 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.3, duration: 0.8 }}
                  className="mt-16 pt-10 border-t border-[#d4e0d4] bg-white/60 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-lg"
                >
                  <h2 className="text-4xl md:text-5xl font-serif text-[#3f513f] text-center mb-10">
                    Cart Pricing Overview
                  </h2>

                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    {/* Breakfast & Sandwiches */}
                    <div className="space-y-4">
                      <h3 className="text-2xl font-semibold text-[#3f513f]">Breakfast / Sandwiches Cart</h3>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(1-20) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">1800 AED</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(20-30) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">2650 AED</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(30-50) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">3950 AED</span>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Pizza Cart */}
                    <div className="space-y-4">
                      <h3 className="text-2xl font-semibold text-[#3f513f]">Pizza Cart</h3>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(1-20) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">2200 AED</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(20-30) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">3050 AED</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(30-50) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">4350 AED</span>
                        </div>
                      </div>
                    </div>

                    {/* Sweets / Candy / Cheese / Drinks */}
                    <div className="space-y-4">
                      <h3 className="text-2xl font-semibold text-[#3f513f]">Sweets / Candy / Cheese / Drinks</h3>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(1-20) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">500 AED</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(20-30) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">750 AED</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-[#5f7a47] font-medium">(30-50) Guests</span>
                          <span className="text-xl font-bold text-[#6b8e23]">1000 AED</span>
                        </div>
                        <div className="pt-4 border-t border-[#d4e0d4]">
                          <p className="text-[#6b8e23] font-medium italic">+300 AED With Station (where applicable)</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-center md:text-left max-w-3xl mx-auto">
                    <h3 className="text-3xl font-serif text-[#3f513f] mb-6">Delivery Prices</h3>
