...
import { Home, UtensilsCrossed, CalendarDays, ImageIcon, HelpCircle, Phone, X, Menu, Info, Sparkles,Credit-card } from "lucide-react";
...
const navItems = [
  ...
  { icon: CalendarDays, label: "Book Now", href: "/booking" },
    { icon: ImageIcon, label: "Payment", href: "#gallery" },
      { icon: ImageIcon, label: "Service", href: "#gallery" },
